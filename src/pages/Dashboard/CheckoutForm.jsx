        ...
        if (confirmError) {
            ...
            if (paymentIntent.status === 'succeeded') {
                ...
                const payment = {
                    ...
                    date: new Date(), // utc date convert. use moment js for convert
    ...
    <div className="my-10">
        <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center mt-10">
                <button className="bg-[#570DF8] text-white px-28 py-1.5 rounded-md font-medium" type="submit" disabled={!stripe || !clientSecret}>
                    Pay
                </button>
            </div>
